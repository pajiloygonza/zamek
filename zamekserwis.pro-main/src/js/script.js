...
document.addEventListener("DOMContentLoaded", function () {
  ...
  L.circle([54.352, 18.6466], {
    ...
    .addTo(map)
    .bindPopup("Gdańsk – Obszar do 2 km");
  ...
  L.circle([54.352, 18.6466], {
    ...
    .addTo(map)
    .bindPopup("Gdańsk – Obszar do 5 km");
  ...
  L.circle([54.352, 18.6466], {
    ...
    .addTo(map)
    .bindPopup("Gdańsk – Obszar do 25 km");
  ...
  L.marker([54.352, 18.6466], { pane: "marker-top" }).addTo(map).bindPopup(`
    <div style="font-size: 14px;">
      ...
      <span style="color: #f39c12;">★ ★ ★ ★ ☆</span> (129 opinii)<br>
      <a href="https://goo.gl/maps/..." target="_blank">Zobacz w Google Maps</a>
    </div>
  `);
  ...
  L.circle([54.4417, 18.56], {
    ...
    .addTo(map)
    .bindPopup("Sopot – Obszar do 800 m");
  ...
  L.circle([54.4417, 18.56], {
    ...
    .addTo(map)
    .bindPopup("Sopot – Obszar do 2 km");
});